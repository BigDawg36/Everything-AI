...
A ready-to-upload bundle of **248 chat-friendly skills** for the **Claude.ai app** (web/desktop chat).
...
sandbox. (The 27 tool/machine-only skills are listed in `EXCLUDED.md` and belong in Claude Code.)
...
chat-skills-bundle/
├── README.md            # this file
├── MANIFEST.md          # all 248 skills + descriptions
├── EXCLUDED.md          # the 27 skills left out (and why)
...
> Tip: You don't need all 248. Pick the ones matching your work (e.g. `copywriting`, `cro`,
